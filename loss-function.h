...
namespace NNFS {
    ...
    struct ILossFun {
        ...
        private:
        static constexpr auto dist_impl = [](auto &self, const auto& z, const auto& y) {
            return self.dist(z, y);
        };
        static constexpr auto avg_dist_impl = [](auto &self, const auto& d, const auto& pred) {
            return self.avg_dist(d, pred);
        };

        static constexpr auto gradient_impl = [](auto &self, const auto& y_pred, const auto& y) {
